...
var _scoreboard = __webpack_require__(30);

var _scoreboard2 = _interopRequireDefault(_scoreboard);

var _current = __webpack_require__(31);
...
var Game = function (_React$Component) {
    ...
    function Game() {
        ...
        _this.grid = (0, _util.generateBoard)();
        _this.clean = JSON.parse(JSON.stringify(_this.grid));
        _this.selected = [];
    ...
    _createClass(Game, [{
        ...
        value: function deselectLetter(pos) {
            ...
            this.selected.pop();
            var recent = this.selected[this.selected.length - 1];

            if (recent) {
                this.grid[recent[0]][recent[1]].recent = true;
            }

            var newWord = this.state.currentWord.substring(0, this.state.currentWord.length - 1);
        ...
        value: function selectLetter(pos, value) {
            ...
            if ((0, _util.adjacentPos)(curPos, pos)) {
        ...
        value: function submitWord() {
            ...
            this.state.scores[this.state.currentWord] = (0, _util.getScore)(this.state.currentWord);
...
var _die = __webpack_require__(29);
        ...
        value: function renderRows() {
            ...
            return this.props.grid.map(function (row, i) {
                return _react2.default.createElement(
                    'div',
                    { className: 'row' },
                    row.map(function (die, j) {
                        var pos = [i, j];
                        return _react2.default.createElement(_die2.default, { die: die, selectLetter: function selectLetter() {
                                return _this2.props.selectLetter(pos, die.value);
                            } });
                    })
                );
            });
...
var Die = function (_React$Component) {
    ...
    _createClass(Die, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                "div",
                { className: this.props.die.selected ? "die-selected" : "die", id: this.props.die.recent ? "recent" : "selected", onClick: this.props.selectLetter },
    ...
    _createClass(Scoreboard, [{
        ...
        value: function renderScores() {
            ...
            if (Object.keys(scores).length > 0) {
                return Object.keys(scores).map(function (word) {
                    return _react2.default.createElement(
                        "tr",
        ...
        value: function getTotal() {
            var total = 0;
            Object.values(this.props.scores).map(function (score) {
                total += score;
            });
            return total;
        }
...
var generateBoard = exports.generateBoard = function generateBoard() {
    var gridSize = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 5;

    var dice = shuffleDice();
    var grid = [];

    for (var i = 0; i < gridSize; i++) {
        grid.push([]);
        for (var j = 0; j < gridSize; j++) {
            var value = dice[i * 5 + j][Math.floor(Math.random() * 6)].toUpperCase();
            if (value == "Q") {
                value = "Qu";
            }
            var tile = { value: value, pos: [i, j], selected: false, recent: false };
            grid[i].push(tile);
        }
    }
    return grid;
...
var shuffleDice = exports.shuffleDice = function shuffleDice() {
...
var adjacentPos = exports.adjacentPos = function adjacentPos(curPos, pos) {
    if (curPos == null) {
        return true;
    }
...
var getScore = exports.getScore = function getScore(word) {
    switch (true) {
        case word.length < 3:
            return 0;
            break;
